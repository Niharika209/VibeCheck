...
import { getFirestore } from "firebase/firestore";  // <-- this line is necessary!
...
const firebaseConfig = {
  ...
  storageBucket: "vibecheck-68ae9.firebasestorage.app", //"vibecheck-68ae9.appspot.com", // fix the typo here (app → appspot)
